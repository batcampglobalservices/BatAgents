...
const navItems = [
  ...
  { href: "/dashboard/user/agents", label: "Agents", description: "Review the agents already on your roster.", icon: <Bot className="h-4 w-4" /> },
  { href: "/dashboard/user/proofs", label: "Proofs", description: "Track completed work and saved receipts.", icon: <BadgeCheck className="h-4 w-4" /> },
    ...
    >
      <section className="border border-white/10 bg-white/5 p-6 backdrop-blur">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="border border-white/10 bg-slate-950/60 px-4 py-2 text-xs font-medium text-slate-300">
